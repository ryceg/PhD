...
\mainmatter{}
\input{./components/progressReport.tex}
\input{./mainmatter/introduction.tex}
% \input{./components/background.tex}
\input{./components/keyQuestions.tex}
\input{./components/aims.tex}
\input{./components/literatureReview.tex}
\input{./components/methodology.tex}
% \input{./components/timeline.tex}
\input{./components/outcomes.tex}
\input{./components/outputs.tex}
